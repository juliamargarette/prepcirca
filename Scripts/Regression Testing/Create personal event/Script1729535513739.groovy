...
WebUI.click(findTestObject('Object Repository/Page_PrepCirca V2/div_Login'))
...
WebUI.setText(findTestObject('Object Repository/Page_PrepCirca V2/input__name'), 'RT_PERSONAL EVENT')

WebUI.click(findTestObject('Object Repository/Page_PrepCirca V2/div__tomselect-1-ts-control'))

WebUI.click(findTestObject('Object Repository/Page_PrepCirca V2/div_Personal'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_PrepCirca V2/select_Select an option HolidaySchool Event_3c80b6'), 
    'PERSONAL', true)

WebUI.click(findTestObject('Object Repository/Page_PrepCirca V2/input__box rounded-md w-full px-3 py-2 bloc_2bc69b'))

WebUI.click(findTestObject('Object Repository/Page_PrepCirca V2/span_28'))

WebUI.click(findTestObject('Object Repository/Page_PrepCirca V2/input__box rounded-md w-full px-3 py-2 bloc_2bc69b_1'))

WebUI.click(findTestObject('Object Repository/Page_PrepCirca V2/span_29'))
